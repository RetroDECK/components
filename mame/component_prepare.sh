...
sed -i 's#RETRODECKROMSDIR#'"$rd_home_roms_path"'#g' "$mameconf" # one-off as roms folders are a lot
set_setting_value "$mameconf" "nvram_directory" "$rd_home_saves_path/mame-sa/nvram" "mame"
set_setting_value "$mameconf" "state_directory" "$rd_home_states_path/mame-sa" "mame"
set_setting_value "$mameconf" "snapshot_directory" "$rd_home_screenshots_path/mame-sa" "mame"
set_setting_value "$mameconf" "diff_directory" "$rd_home_saves_path/mame-sa/diff" "mame"
set_setting_value "$mameconf" "samplepath" "$rd_home_bios_path/mame-sa/samples" "mame"
set_setting_value "$mameconf" "cheatpath" "$rd_home_cheats_path/mame" "mame"
set_setting_value "$mameconf" "bgfx_path" "$rd_home_shaders_path/mame/bgfx/" "mame"
