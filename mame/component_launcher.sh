...
export LD_LIBRARY_PATH="$component_path/lib:$rd_shared_libs:$rd_shared_libs/org.freedesktop.Platform/24.08/:$rd_shared_libs/org.kde.Platform/6.10/:${LD_LIBRARY_PATH}"
