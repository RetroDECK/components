...
srm_log="$logs_folder/srm_log.log"                                                                                      # Log file for capturing the output of the most recent SRM run, for debugging purposes                                                                                     # Log file for capturing the output of the most recent SRM run, for debugging purposes
