...
export LD_LIBRARY_PATH="$component_path/lib:$rd_shared_libs:$rd_shared_libs/org.kde.Platform/6.10/:$rd_shared_libs/org.kde.Sdk/6.10/:$rd_shared_libs/org.gnome.Platform/49/:$ffmpeg_path/25.08:$rd_shared_libs/org.freedesktop.Platform/25.08/:${LD_LIBRARY_PATH}"
