...
# Set LD_LIBRARY_PATH
export LD_LIBRARY_PATH="$component_path/lib:$component_path/lib32:/app/retrodeck/components/shared-libs/qt-6.8/lib:${LD_LIBRARY_PATH}"
...
exec "$component_path/bin/lindbergh" "$@"
