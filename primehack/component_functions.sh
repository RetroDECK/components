...
primehack_config_Dolphin="$XDG_CONFIG_HOME/primehack/Dolphin.ini"
primehack_config_DSUClient="$XDG_CONFIG_HOME/primehack/DSUClient.ini"
primehack_config_FreeLookControlle="$XDG_CONFIG_HOME/primehack/FreeLookController.ini"
...
primehack_config_GCKeyNe="$XDG_CONFIG_HOME/primehack/GCKeyNew.ini"
