...
if [[ "$action" == "reset" ]]; then # Run reset-only commands
  ...
  set_setting_value "$melonds_config" "SaveFilePath" "$saves_path/nds/melonds" "melonds"
  set_setting_value "$melonds_config" "SavestatePath" "$states_path/nds/melonds" "melonds"
