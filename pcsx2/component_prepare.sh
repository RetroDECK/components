...
if [[ "$action" == "reset" ]]; then # Run reset-only commands
  ...
  if [[ $multi_user_mode == "true" ]]; then # Multi-user actions
    ...
    set_setting_value "$pcsx2_config_PCSX2" "Bios" "$rd_home_bios_path" "pcsx2" "Folders"
    set_setting_value "$pcsx2_config_PCSX2" "Snapshots" "$rd_home_screenshots_path" "pcsx2" "Folders"
    set_setting_value "$pcsx2_config_PCSX2" "SaveStates" "$rd_home_states_path/ps2/pcsx2" "pcsx2" "Folders"
    set_setting_value "$pcsx2_config_PCSX2" "MemoryCards" "$rd_home_saves_path/ps2/pcsx2/memcards" "pcsx2" "Folders"
    set_setting_value "$pcsx2_config_PCSX2" "RecursivePaths" "$rd_home_roms_path/ps2" "pcsx2" "GameList"
    set_setting_value "$pcsx2_config_PCSX2" "Cheats" "$rd_home_cheats_path/pcsx2" "Folders"
